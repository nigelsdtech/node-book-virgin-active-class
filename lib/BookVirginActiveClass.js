var cfg                = require('config'),
    ...
    VirginActive       = require('./VirginActive.js');
...
module.exports = function (programComplete) {
  ...
  .then (function (contactVA) {
    ...
    return Q.nfcall(VirginActive.process, null)
  ...
  .then (function (bookingStatus) {
    ...
    var msg = cfg.va.classToBook.name + ' (' + cfg.va.classToBook.date + ' ' + cfg.va.classToBook.time + ')' + ' booking status: ' + bookingStatus
    log.info(msg)
